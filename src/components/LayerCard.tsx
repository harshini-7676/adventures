...
import type { EarthLayer } from '../data/earth';
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Depth indicator bar */}
          <div className="absolute left-0 top-0 bottom-0 w-1.5" style={{ background: layer.accent }} />
          ...
          <div className="relative z-10 pl-2">
            <div className="flex items-start justify-between mb-6">
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="font-mono text-[10px] text-slate-500">{layer.depth.split(' – ')[0]}km</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Stat label="Depth" value={layer.depth} />
              <Stat label="Temperature" value={layer.temperature} />
              <Stat label="Pressure" value={layer.pressure} />
              <Stat label="Composition" value={layer.composition} />
            </div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(180deg, ${layer.color}, ${layer.accent})`,
                boxShadow: `0 0 60px -10px ${layer.accent}`,
              }}
            >
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Stat label="Depth Range" value={layer.depth} large />
              <Stat label="Temperature" value={layer.temperature} large />
              <Stat label="Pressure" value={layer.pressure} large />
              <Stat label="Composition" value={layer.composition} large />
            </div>
